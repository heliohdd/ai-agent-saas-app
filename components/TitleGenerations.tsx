  ...
  const titles = [
    {
      videoId: "asdçflkj",
      userId: "Luke Davis",
      title: "iPhone 16e Review: Who Are You Really For at $599?",
      _id: "_id",
    },
  ...
  return (
    <div className="p-4 border border-gray-200 rounded-xl bg-white shadow-sm">
      ...
      <div className="space-y-3 mt-4 max-h-[280px] overflow-y-auto">
        {
          !titles?.map((title) => (
            //  TODO: Reactivate this line # titles?.map((title) => (
            <div
              key={title._id}
      ...
      {titles?.length && !!isTitleGenerationEnabled && (
        //  TODO: Reactivate this line # {!titles?.length && !!isTitleGenerationEnabled && (
